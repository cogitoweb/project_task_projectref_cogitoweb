...
insert into project_task(create_date,
  ...
  b.invoice_date, 1, a.project_id, b.invoice_date, b.write_date, true, 
  case when b.invoiced = true then 7 else 2 end, 'Milestone ' || to_char(b.invoice_date::timestamp,'DD/MM/YYYY'), b.invoice_date, 1,
  0,0, b.sale_order_id, true, b.invoiced, b.planned_amount, b.invoice_date,0,0,0
